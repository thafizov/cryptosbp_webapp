...
const BalanceSection = ({ 
  ...
  return (
    <div className="bg-gradient-to-br from-accent-green to-accent-yellow rounded-2xl mb-6 adaptive-p-5 text-black">
      ...
      <div className="balance-text text-black mb-6 md:mb-8">
